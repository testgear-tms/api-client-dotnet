...
namespace TestGear.Client.Api
{
    ...
    public partial class SectionsApi : IDisposable, ISectionsApi
    {
        ...
        /// <param name="isDeleted">Requested section is deleted (optional, default to false)</param>
        /// <returns>ApiResponse of SectionWithStepsModel</returns>
        public TestGear.Client.Client.ApiResponse<SectionWithStepsModel> GetSectionByIdWithHttpInfo(Guid id, bool? isDeleted = default(bool?))
        {
            TestGear.Client.Client.RequestOptions localVarRequestOptions = new TestGear.Client.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SectionWithStepsModel)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<SectionWithStepsModel>> GetSectionByIdWithHttpInfoAsync(Guid id, bool? isDeleted = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
