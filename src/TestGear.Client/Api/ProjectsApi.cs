...
namespace TestGear.Client.Api
{
    ...
    {
        private TestGear.Client.Client.ExceptionFactory _exceptionFactory = (name, response) => null;
        ...
        {
            this.Configuration = TestGear.Client.Client.Configuration.MergeConfigurations(
                TestGear.Client.Client.GlobalConfiguration.Instance,
                new TestGear.Client.Client.Configuration { BasePath = basePath }
            );
            this.ApiClient = new TestGear.Client.Client.ApiClient(this.Configuration.BasePath);
            this.Client =  this.ApiClient;
            this.AsynchronousClient = this.ApiClient;
            this.ExceptionFactory = TestGear.Client.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        /// <returns></returns>
        public ProjectsApi(TestGear.Client.Client.Configuration configuration)
        {
            ...
            this.Client = this.ApiClient;
            this.AsynchronousClient = this.ApiClient;
            ExceptionFactory = TestGear.Client.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        public ProjectsApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
            ...
            this.ApiClient = new TestGear.Client.Client.ApiClient(client, this.Configuration.BasePath, handler);
            this.Client =  this.ApiClient;
            this.AsynchronousClient = this.ApiClient;
            this.ExceptionFactory = TestGear.Client.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public ProjectsApi(HttpClient client, TestGear.Client.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public ProjectsApi(TestGear.Client.Client.ISynchronousClient client, TestGear.Client.Client.IAsynchronousClient asyncClient, TestGear.Client.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// </summary>
        public TestGear.Client.Client.ApiClient ApiClient { get; set; } = null;

        /// <summary>
        /// The client for accessing this underlying API asynchronously.
        /// </summary>
        public TestGear.Client.Client.IAsynchronousClient AsynchronousClient { get; set; }

        /// <summary>
        /// The client for accessing this underlying API synchronously.
        /// </summary>
        public TestGear.Client.Client.ISynchronousClient Client { get; set; }
        ...
        public TestGear.Client.Client.IReadableConfiguration Configuration { get; set; }

        /// <summary>
        /// Provides a factory method hook for the creation of exceptions.
        /// </summary>
        public TestGear.Client.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
        ...
        /// <param name="requestBody"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public TestGear.Client.Client.ApiResponse<Object> AddGlobaAttributesToProjectWithHttpInfo(string id, List<Guid> requestBody = default(List<Guid>))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->AddGlobaAttributesToProject");

            TestGear.Client.Client.RequestOptions localVarRequestOptions = new TestGear.Client.Client.RequestOptions();
            ...
            var localVarContentType = TestGear.Client.Client.ClientUtils.SelectHeaderContentType(_contentTypes);
            if (localVarContentType != null) localVarRequestOptions.HeaderParameters.Add("Content-Type", localVarContentType);

            var localVarAccept = TestGear.Client.Client.ClientUtils.SelectHeaderAccept(_accepts);
            if (localVarAccept != null) localVarRequestOptions.HeaderParameters.Add("Accept", localVarAccept);

            localVarRequestOptions.PathParameters.Add("id", TestGear.Client.Client.ClientUtils.ParameterToString(id)); // path parameter
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Object>> AddGlobaAttributesToProjectWithHttpInfoAsync(string id, List<Guid> requestBody = default(List<Guid>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->AddGlobaAttributesToProject");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<ProjectCustomAttributeTemplateGetModel>> localVarResponse = ApiV2ProjectsIdAttributesTemplatesSearchPostWithHttpInfo(id, skip, take, orderBy, searchField, searchValue, projectCustomAttributesTemplatesFilterModel);
        ...
        /// <param name="projectCustomAttributesTemplatesFilterModel"> (optional)</param>
        /// <returns>ApiResponse of List&lt;ProjectCustomAttributeTemplateGetModel&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<ProjectCustomAttributeTemplateGetModel>> ApiV2ProjectsIdAttributesTemplatesSearchPostWithHttpInfo(string id, int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), ProjectCustomAttributesTemplatesFilterModel projectCustomAttributesTemplatesFilterModel = default(ProjectCustomAttributesTemplatesFilterModel))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdAttributesTemplatesSearchPost");
            ...
            if (skip != null)
            {
                localVarRequestOptions.QueryParameters.Add(TestGear.Client.Client.ClientUtils.ParameterToMultiMap("", "Skip", skip));
            }
            if (take != null)
            {
                localVarRequestOptions.QueryParameters.Add(TestGear.Client.Client.ClientUtils.ParameterToMultiMap("", "Take", take));
            }
            if (orderBy != null)
            {
                localVarRequestOptions.QueryParameters.Add(TestGear.Client.Client.ClientUtils.ParameterToMultiMap("", "OrderBy", orderBy));
            }
            if (searchField != null)
            {
                localVarRequestOptions.QueryParameters.Add(TestGear.Client.Client.ClientUtils.ParameterToMultiMap("", "SearchField", searchField));
            }
            if (searchValue != null)
            {
                localVarRequestOptions.QueryParameters.Add(TestGear.Client.Client.ClientUtils.ParameterToMultiMap("", "SearchValue", searchValue));
            }
        ...
        {
            TestGear.Client.Client.ApiResponse<List<ProjectCustomAttributeTemplateGetModel>> localVarResponse = await ApiV2ProjectsIdAttributesTemplatesSearchPostWithHttpInfoAsync(id, skip, take, orderBy, searchField, searchValue, projectCustomAttributesTemplatesFilterModel, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ProjectCustomAttributeTemplateGetModel&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<ProjectCustomAttributeTemplateGetModel>>> ApiV2ProjectsIdAttributesTemplatesSearchPostWithHttpInfoAsync(string id, int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), ProjectCustomAttributesTemplatesFilterModel projectCustomAttributesTemplatesFilterModel = default(ProjectCustomAttributesTemplatesFilterModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdAttributesTemplatesSearchPost");
        ...
        /// <param name="templateId">CustomAttributeTemplate internal (UUID) identifier</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public TestGear.Client.Client.ApiResponse<Object> ApiV2ProjectsIdAttributesTemplatesTemplateIdDeleteWithHttpInfo(string id, Guid templateId)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdAttributesTemplatesTemplateIdDelete");
            ...
            localVarRequestOptions.PathParameters.Add("id", TestGear.Client.Client.ClientUtils.ParameterToString(id)); // path parameter
            localVarRequestOptions.PathParameters.Add("templateId", TestGear.Client.Client.ClientUtils.ParameterToString(templateId)); // path parameter
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Object>> ApiV2ProjectsIdAttributesTemplatesTemplateIdDeleteWithHttpInfoAsync(string id, Guid templateId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdAttributesTemplatesTemplateIdDelete");
        ...
        /// <param name="templateId">CustomAttributeTemplate internal (UUID) identifier</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public TestGear.Client.Client.ApiResponse<Object> ApiV2ProjectsIdAttributesTemplatesTemplateIdPostWithHttpInfo(string id, Guid templateId)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdAttributesTemplatesTemplateIdPost");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Object>> ApiV2ProjectsIdAttributesTemplatesTemplateIdPostWithHttpInfoAsync(string id, Guid templateId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdAttributesTemplatesTemplateIdPost");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<FailureClassModel>> localVarResponse = ApiV2ProjectsIdFailureClassesGetWithHttpInfo(id, isDeleted);
            return localVarResponse.Data;
        }
        ...
        /// <param name="isDeleted"> (optional)</param>
        /// <returns>ApiResponse of List&lt;FailureClassModel&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<FailureClassModel>> ApiV2ProjectsIdFailureClassesGetWithHttpInfo(string id, bool? isDeleted = default(bool?))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdFailureClassesGet");
            ...
            if (isDeleted != null)
            {
                localVarRequestOptions.QueryParameters.Add(TestGear.Client.Client.ClientUtils.ParameterToMultiMap("", "isDeleted", isDeleted));
            }
        ...
        {
            TestGear.Client.Client.ApiResponse<List<FailureClassModel>> localVarResponse = await ApiV2ProjectsIdFailureClassesGetWithHttpInfoAsync(id, isDeleted, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;FailureClassModel&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<FailureClassModel>>> ApiV2ProjectsIdFailureClassesGetWithHttpInfoAsync(string id, bool? isDeleted = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdFailureClassesGet");
        ...
        /// <param name="id">Project internal (UUID) or global (integer) identifier</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public TestGear.Client.Client.ApiResponse<Object> ApiV2ProjectsIdFavoritePutWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdFavoritePut");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Object>> ApiV2ProjectsIdFavoritePutWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdFavoritePut");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<FilterModel>> localVarResponse = ApiV2ProjectsIdFiltersGetWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">Project internal (UUID) or global (integer) identifier</param>
        /// <returns>ApiResponse of List&lt;FilterModel&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<FilterModel>> ApiV2ProjectsIdFiltersGetWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdFiltersGet");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<FilterModel>> localVarResponse = await ApiV2ProjectsIdFiltersGetWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;FilterModel&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<FilterModel>>> ApiV2ProjectsIdFiltersGetWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdFiltersGet");
        ...
        /// <param name="operation"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public TestGear.Client.Client.ApiResponse<Object> ApiV2ProjectsIdPatchWithHttpInfo(Guid id, List<Operation> operation = default(List<Operation>))
        {
            TestGear.Client.Client.RequestOptions localVarRequestOptions = new TestGear.Client.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Object>> ApiV2ProjectsIdPatchWithHttpInfoAsync(Guid id, List<Operation> operation = default(List<Operation>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            TestGear.Client.Client.ApiResponse<List<TestPlanWithAnalyticModel>> localVarResponse = ApiV2ProjectsIdTestPlansAnalyticsGetWithHttpInfo(id, isDeleted, mustUpdateCache, skip, take, orderBy, searchField, searchValue);
            return localVarResponse.Data;
        }
        ...
        /// <param name="searchValue">Value for searching (optional)</param>
        /// <returns>ApiResponse of List&lt;TestPlanWithAnalyticModel&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<TestPlanWithAnalyticModel>> ApiV2ProjectsIdTestPlansAnalyticsGetWithHttpInfo(Guid id, bool? isDeleted = default(bool?), bool? mustUpdateCache = default(bool?), int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string))
        {
            TestGear.Client.Client.RequestOptions localVarRequestOptions = new TestGear.Client.Client.RequestOptions();
            ...
            {
                localVarRequestOptions.QueryParameters.Add(TestGear.Client.Client.ClientUtils.ParameterToMultiMap("", "mustUpdateCache", mustUpdateCache));
            }
            if (skip != null)
            {
                localVarRequestOptions.QueryParameters.Add(TestGear.Client.Client.ClientUtils.ParameterToMultiMap("", "Skip", skip));
        ...
        public async System.Threading.Tasks.Task<List<TestPlanWithAnalyticModel>> ApiV2ProjectsIdTestPlansAnalyticsGetAsync(Guid id, bool? isDeleted = default(bool?), bool? mustUpdateCache = default(bool?), int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            TestGear.Client.Client.ApiResponse<List<TestPlanWithAnalyticModel>> localVarResponse = await ApiV2ProjectsIdTestPlansAnalyticsGetWithHttpInfoAsync(id, isDeleted, mustUpdateCache, skip, take, orderBy, searchField, searchValue, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;TestPlanWithAnalyticModel&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<TestPlanWithAnalyticModel>>> ApiV2ProjectsIdTestPlansAnalyticsGetWithHttpInfoAsync(Guid id, bool? isDeleted = default(bool?), bool? mustUpdateCache = default(bool?), int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            TestGear.Client.Client.ApiResponse<List<Guid>> localVarResponse = ApiV2ProjectsIdTestPlansDeleteBulkPostWithHttpInfo(id, projectTestPlansFilterModel);
            return localVarResponse.Data;
        }
        ...
        /// <param name="projectTestPlansFilterModel"> (optional)</param>
        /// <returns>ApiResponse of List&lt;Guid&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<Guid>> ApiV2ProjectsIdTestPlansDeleteBulkPostWithHttpInfo(string id, ProjectTestPlansFilterModel projectTestPlansFilterModel = default(ProjectTestPlansFilterModel))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdTestPlansDeleteBulkPost");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<Guid>> localVarResponse = await ApiV2ProjectsIdTestPlansDeleteBulkPostWithHttpInfoAsync(id, projectTestPlansFilterModel, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Guid&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<Guid>>> ApiV2ProjectsIdTestPlansDeleteBulkPostWithHttpInfoAsync(string id, ProjectTestPlansFilterModel projectTestPlansFilterModel = default(ProjectTestPlansFilterModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdTestPlansDeleteBulkPost");
        ...
        {
            TestGear.Client.Client.ApiResponse<bool> localVarResponse = ApiV2ProjectsIdTestPlansNameExistsGetWithHttpInfo(id, name);
            return localVarResponse.Data;
        }
        ...
        /// <param name="name">TestPlan name to check</param>
        /// <returns>ApiResponse of bool</returns>
        public TestGear.Client.Client.ApiResponse<bool> ApiV2ProjectsIdTestPlansNameExistsGetWithHttpInfo(Guid id, string name)
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'name' when calling ProjectsApi->ApiV2ProjectsIdTestPlansNameExistsGet");
            ...
            localVarRequestOptions.PathParameters.Add("id", TestGear.Client.Client.ClientUtils.ParameterToString(id)); // path parameter
            localVarRequestOptions.PathParameters.Add("name", TestGear.Client.Client.ClientUtils.ParameterToString(name)); // path parameter
        ...
        {
            TestGear.Client.Client.ApiResponse<bool> localVarResponse = await ApiV2ProjectsIdTestPlansNameExistsGetWithHttpInfoAsync(id, name, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (bool)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<bool>> ApiV2ProjectsIdTestPlansNameExistsGetWithHttpInfoAsync(Guid id, string name, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'name' when calling ProjectsApi->ApiV2ProjectsIdTestPlansNameExistsGet");
        ...
        /// <param name="projectTestPlansFilterModel"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public TestGear.Client.Client.ApiResponse<Object> ApiV2ProjectsIdTestPlansRestoreBulkPostWithHttpInfo(string id, ProjectTestPlansFilterModel projectTestPlansFilterModel = default(ProjectTestPlansFilterModel))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdTestPlansRestoreBulkPost");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Object>> ApiV2ProjectsIdTestPlansRestoreBulkPostWithHttpInfoAsync(string id, ProjectTestPlansFilterModel projectTestPlansFilterModel = default(ProjectTestPlansFilterModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdTestPlansRestoreBulkPost");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<TestPlanWithAnalyticModel>> localVarResponse = ApiV2ProjectsIdTestPlansSearchPostWithHttpInfo(id, mustUpdateCache, skip, take, orderBy, searchField, searchValue, projectTestPlansFilterModel);
            return localVarResponse.Data;
        }
        ...
        /// <param name="projectTestPlansFilterModel"> (optional)</param>
        /// <returns>ApiResponse of List&lt;TestPlanWithAnalyticModel&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<TestPlanWithAnalyticModel>> ApiV2ProjectsIdTestPlansSearchPostWithHttpInfo(string id, bool? mustUpdateCache = default(bool?), int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), ProjectTestPlansFilterModel projectTestPlansFilterModel = default(ProjectTestPlansFilterModel))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdTestPlansSearchPost");
        ...
        public async System.Threading.Tasks.Task<List<TestPlanWithAnalyticModel>> ApiV2ProjectsIdTestPlansSearchPostAsync(string id, bool? mustUpdateCache = default(bool?), int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), ProjectTestPlansFilterModel projectTestPlansFilterModel = default(ProjectTestPlansFilterModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            TestGear.Client.Client.ApiResponse<List<TestPlanWithAnalyticModel>> localVarResponse = await ApiV2ProjectsIdTestPlansSearchPostWithHttpInfoAsync(id, mustUpdateCache, skip, take, orderBy, searchField, searchValue, projectTestPlansFilterModel, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;TestPlanWithAnalyticModel&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<TestPlanWithAnalyticModel>>> ApiV2ProjectsIdTestPlansSearchPostWithHttpInfoAsync(string id, bool? mustUpdateCache = default(bool?), int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), ProjectTestPlansFilterModel projectTestPlansFilterModel = default(ProjectTestPlansFilterModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdTestPlansSearchPost");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<PublicTestRunModel>> localVarResponse = ApiV2ProjectsIdTestRunsActiveGetWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">Project internal (UUID) or global (integer) identifier</param>
        /// <returns>ApiResponse of List&lt;PublicTestRunModel&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<PublicTestRunModel>> ApiV2ProjectsIdTestRunsActiveGetWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdTestRunsActiveGet");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<PublicTestRunModel>> localVarResponse = await ApiV2ProjectsIdTestRunsActiveGetWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;PublicTestRunModel&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<PublicTestRunModel>>> ApiV2ProjectsIdTestRunsActiveGetWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdTestRunsActiveGet");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<TestRunModel>> localVarResponse = ApiV2ProjectsIdTestRunsFullGetWithHttpInfo(id, includeTestResults, mustAggregateTestResults, notStarted, inProgress, stopped, completed, createdDateFrom, createdDateTo, testPlanId, skip, take, orderBy, searchField, searchValue);
            return localVarResponse.Data;
        }
        ...
        /// <param name="searchValue">Value for searching (optional)</param>
        /// <returns>ApiResponse of List&lt;TestRunModel&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<TestRunModel>> ApiV2ProjectsIdTestRunsFullGetWithHttpInfo(string id, bool? includeTestResults = default(bool?), bool? mustAggregateTestResults = default(bool?), bool? notStarted = default(bool?), bool? inProgress = default(bool?), bool? stopped = default(bool?), bool? completed = default(bool?), DateTime? createdDateFrom = default(DateTime?), DateTime? createdDateTo = default(DateTime?), Guid? testPlanId = default(Guid?), int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdTestRunsFullGet");
            ...
            {
                localVarRequestOptions.QueryParameters.Add(TestGear.Client.Client.ClientUtils.ParameterToMultiMap("", "includeTestResults", includeTestResults));
            }
            if (mustAggregateTestResults != null)
            {
                localVarRequestOptions.QueryParameters.Add(TestGear.Client.Client.ClientUtils.ParameterToMultiMap("", "mustAggregateTestResults", mustAggregateTestResults));
            }
            if (notStarted != null)
            {
                localVarRequestOptions.QueryParameters.Add(TestGear.Client.Client.ClientUtils.ParameterToMultiMap("", "notStarted", notStarted));
            }
            if (inProgress != null)
            {
                localVarRequestOptions.QueryParameters.Add(TestGear.Client.Client.ClientUtils.ParameterToMultiMap("", "inProgress", inProgress));
            }
            if (stopped != null)
            {
                localVarRequestOptions.QueryParameters.Add(TestGear.Client.Client.ClientUtils.ParameterToMultiMap("", "stopped", stopped));
            }
            if (completed != null)
            {
                localVarRequestOptions.QueryParameters.Add(TestGear.Client.Client.ClientUtils.ParameterToMultiMap("", "completed", completed));
            }
            if (createdDateFrom != null)
            {
                localVarRequestOptions.QueryParameters.Add(TestGear.Client.Client.ClientUtils.ParameterToMultiMap("", "createdDateFrom", createdDateFrom));
            }
            if (createdDateTo != null)
            {
                localVarRequestOptions.QueryParameters.Add(TestGear.Client.Client.ClientUtils.ParameterToMultiMap("", "createdDateTo", createdDateTo));
            }
            if (testPlanId != null)
            {
                localVarRequestOptions.QueryParameters.Add(TestGear.Client.Client.ClientUtils.ParameterToMultiMap("", "testPlanId", testPlanId));
            }
            if (skip != null)
            {
                localVarRequestOptions.QueryParameters.Add(TestGear.Client.Client.ClientUtils.ParameterToMultiMap("", "Skip", skip));
        ...
        public async System.Threading.Tasks.Task<List<TestRunModel>> ApiV2ProjectsIdTestRunsFullGetAsync(string id, bool? includeTestResults = default(bool?), bool? mustAggregateTestResults = default(bool?), bool? notStarted = default(bool?), bool? inProgress = default(bool?), bool? stopped = default(bool?), bool? completed = default(bool?), DateTime? createdDateFrom = default(DateTime?), DateTime? createdDateTo = default(DateTime?), Guid? testPlanId = default(Guid?), int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            TestGear.Client.Client.ApiResponse<List<TestRunModel>> localVarResponse = await ApiV2ProjectsIdTestRunsFullGetWithHttpInfoAsync(id, includeTestResults, mustAggregateTestResults, notStarted, inProgress, stopped, completed, createdDateFrom, createdDateTo, testPlanId, skip, take, orderBy, searchField, searchValue, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;TestRunModel&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<TestRunModel>>> ApiV2ProjectsIdTestRunsFullGetWithHttpInfoAsync(string id, bool? includeTestResults = default(bool?), bool? mustAggregateTestResults = default(bool?), bool? notStarted = default(bool?), bool? inProgress = default(bool?), bool? stopped = default(bool?), bool? completed = default(bool?), DateTime? createdDateFrom = default(DateTime?), DateTime? createdDateTo = default(DateTime?), Guid? testPlanId = default(Guid?), int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdTestRunsFullGet");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<Guid>> localVarResponse = ApiV2ProjectsIdWorkItemsSearchIdPostWithHttpInfo(id, skip, take, orderBy, searchField, searchValue, workItemSelectModel);
            return localVarResponse.Data;
        }
        ...
        /// <param name="workItemSelectModel"> (optional)</param>
        /// <returns>ApiResponse of List&lt;Guid&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<Guid>> ApiV2ProjectsIdWorkItemsSearchIdPostWithHttpInfo(string id, int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), WorkItemSelectModel workItemSelectModel = default(WorkItemSelectModel))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdWorkItemsSearchIdPost");
        ...
        public async System.Threading.Tasks.Task<List<Guid>> ApiV2ProjectsIdWorkItemsSearchIdPostAsync(string id, int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), WorkItemSelectModel workItemSelectModel = default(WorkItemSelectModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            TestGear.Client.Client.ApiResponse<List<Guid>> localVarResponse = await ApiV2ProjectsIdWorkItemsSearchIdPostWithHttpInfoAsync(id, skip, take, orderBy, searchField, searchValue, workItemSelectModel, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Guid&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<Guid>>> ApiV2ProjectsIdWorkItemsSearchIdPostWithHttpInfoAsync(string id, int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), WorkItemSelectModel workItemSelectModel = default(WorkItemSelectModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdWorkItemsSearchIdPost");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<WorkItemShortModel>> localVarResponse = ApiV2ProjectsIdWorkItemsSearchPostWithHttpInfo(id, skip, take, orderBy, searchField, searchValue, workItemSelectModel);
            return localVarResponse.Data;
        }
        ...
        /// <param name="workItemSelectModel"> (optional)</param>
        /// <returns>ApiResponse of List&lt;WorkItemShortModel&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<WorkItemShortModel>> ApiV2ProjectsIdWorkItemsSearchPostWithHttpInfo(string id, int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), WorkItemSelectModel workItemSelectModel = default(WorkItemSelectModel))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdWorkItemsSearchPost");
        ...
        public async System.Threading.Tasks.Task<List<WorkItemShortModel>> ApiV2ProjectsIdWorkItemsSearchPostAsync(string id, int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), WorkItemSelectModel workItemSelectModel = default(WorkItemSelectModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            TestGear.Client.Client.ApiResponse<List<WorkItemShortModel>> localVarResponse = await ApiV2ProjectsIdWorkItemsSearchPostWithHttpInfoAsync(id, skip, take, orderBy, searchField, searchValue, workItemSelectModel, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;WorkItemShortModel&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<WorkItemShortModel>>> ApiV2ProjectsIdWorkItemsSearchPostWithHttpInfoAsync(string id, int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), WorkItemSelectModel workItemSelectModel = default(WorkItemSelectModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ApiV2ProjectsIdWorkItemsSearchPost");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<TagShortModel>> localVarResponse = ApiV2ProjectsIdWorkItemsTagsGetWithHttpInfo(id, isDeleted);
            return localVarResponse.Data;
        }
        ...
        /// <param name="isDeleted"> (optional)</param>
        /// <returns>ApiResponse of List&lt;TagShortModel&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<TagShortModel>> ApiV2ProjectsIdWorkItemsTagsGetWithHttpInfo(Guid id, bool? isDeleted = default(bool?))
        {
            TestGear.Client.Client.RequestOptions localVarRequestOptions = new TestGear.Client.Client.RequestOptions();
        ...
        {
            TestGear.Client.Client.ApiResponse<List<TagShortModel>> localVarResponse = await ApiV2ProjectsIdWorkItemsTagsGetWithHttpInfoAsync(id, isDeleted, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;TagShortModel&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<TagShortModel>>> ApiV2ProjectsIdWorkItemsTagsGetWithHttpInfoAsync(Guid id, bool? isDeleted = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            TestGear.Client.Client.ApiResponse<bool> localVarResponse = ApiV2ProjectsNameNameExistsGetWithHttpInfo(name);
            return localVarResponse.Data;
        }
        ...
        /// <param name="name"></param>
        /// <returns>ApiResponse of bool</returns>
        public TestGear.Client.Client.ApiResponse<bool> ApiV2ProjectsNameNameExistsGetWithHttpInfo(string name)
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'name' when calling ProjectsApi->ApiV2ProjectsNameNameExistsGet");
        ...
        {
            TestGear.Client.Client.ApiResponse<bool> localVarResponse = await ApiV2ProjectsNameNameExistsGetWithHttpInfoAsync(name, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (bool)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<bool>> ApiV2ProjectsNameNameExistsGetWithHttpInfoAsync(string name, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'name' when calling ProjectsApi->ApiV2ProjectsNameNameExistsGet");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<ProjectModel>> localVarResponse = ApiV2ProjectsSearchPostWithHttpInfo(skip, take, orderBy, searchField, searchValue, projectsFilterModel);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<List<ProjectModel>> ApiV2ProjectsSearchPostAsync(int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), ProjectsFilterModel projectsFilterModel = default(ProjectsFilterModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            TestGear.Client.Client.ApiResponse<List<ProjectModel>> localVarResponse = await ApiV2ProjectsSearchPostWithHttpInfoAsync(skip, take, orderBy, searchField, searchValue, projectsFilterModel, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ProjectModel&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<ProjectModel>>> ApiV2ProjectsSearchPostWithHttpInfoAsync(int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), ProjectsFilterModel projectsFilterModel = default(ProjectsFilterModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            TestGear.Client.Client.ApiResponse<Guid> localVarResponse = BackgroundImportProjectWithHttpInfo(file);
            return localVarResponse.Data;
        }
        ...
        /// <param name="file"> (optional)</param>
        /// <returns>ApiResponse of Guid</returns>
        public TestGear.Client.Client.ApiResponse<Guid> BackgroundImportProjectWithHttpInfo(FileParameter file = default(FileParameter))
        {
            TestGear.Client.Client.RequestOptions localVarRequestOptions = new TestGear.Client.Client.RequestOptions();
        ...
        {
            TestGear.Client.Client.ApiResponse<Guid> localVarResponse = await BackgroundImportProjectWithHttpInfoAsync(file, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Guid)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Guid>> BackgroundImportProjectWithHttpInfoAsync(FileParameter file = default(FileParameter), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            TestGear.Client.Client.ApiResponse<Guid> localVarResponse = BackgroundImportToExistingProjectWithHttpInfo(id, file);
            return localVarResponse.Data;
        }
        ...
        /// <param name="file">Select file (optional)</param>
        /// <returns>ApiResponse of Guid</returns>
        public TestGear.Client.Client.ApiResponse<Guid> BackgroundImportToExistingProjectWithHttpInfo(string id, FileParameter file = default(FileParameter))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->BackgroundImportToExistingProject");
        ...
        {
            TestGear.Client.Client.ApiResponse<Guid> localVarResponse = await BackgroundImportToExistingProjectWithHttpInfoAsync(id, file, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Guid)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Guid>> BackgroundImportToExistingProjectWithHttpInfoAsync(string id, FileParameter file = default(FileParameter), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->BackgroundImportToExistingProject");
        ...
        {
            TestGear.Client.Client.ApiResponse<Guid> localVarResponse = BackgroundImportZipProjectWithHttpInfo(file);
            return localVarResponse.Data;
        }
        ...
        /// <param name="file"> (optional)</param>
        /// <returns>ApiResponse of Guid</returns>
        public TestGear.Client.Client.ApiResponse<Guid> BackgroundImportZipProjectWithHttpInfo(FileParameter file = default(FileParameter))
        {
            TestGear.Client.Client.RequestOptions localVarRequestOptions = new TestGear.Client.Client.RequestOptions();
        ...
        {
            TestGear.Client.Client.ApiResponse<Guid> localVarResponse = await BackgroundImportZipProjectWithHttpInfoAsync(file, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Guid)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Guid>> BackgroundImportZipProjectWithHttpInfoAsync(FileParameter file = default(FileParameter), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            TestGear.Client.Client.ApiResponse<Guid> localVarResponse = BackgroundImportZipToExistingProjectWithHttpInfo(id, file);
            return localVarResponse.Data;
        }
        ...
        /// <param name="file">Select file (optional)</param>
        /// <returns>ApiResponse of Guid</returns>
        public TestGear.Client.Client.ApiResponse<Guid> BackgroundImportZipToExistingProjectWithHttpInfo(string id, FileParameter file = default(FileParameter))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->BackgroundImportZipToExistingProject");
        ...
        {
            TestGear.Client.Client.ApiResponse<Guid> localVarResponse = await BackgroundImportZipToExistingProjectWithHttpInfoAsync(id, file, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Guid)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Guid>> BackgroundImportZipToExistingProjectWithHttpInfoAsync(string id, FileParameter file = default(FileParameter), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->BackgroundImportZipToExistingProject");
        ...
        /// <param name="requestBody"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public TestGear.Client.Client.ApiResponse<Object> CreateCustomAttributeTestPlanProjectRelationsWithHttpInfo(string id, List<Guid> requestBody = default(List<Guid>))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->CreateCustomAttributeTestPlanProjectRelations");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Object>> CreateCustomAttributeTestPlanProjectRelationsWithHttpInfoAsync(string id, List<Guid> requestBody = default(List<Guid>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->CreateCustomAttributeTestPlanProjectRelations");
        ...
        {
            TestGear.Client.Client.ApiResponse<ProjectModel> localVarResponse = CreateProjectWithHttpInfo(projectPostModel);
            return localVarResponse.Data;
        }
        ...
        /// <param name="projectPostModel"> (optional)</param>
        /// <returns>ApiResponse of ProjectModel</returns>
        public TestGear.Client.Client.ApiResponse<ProjectModel> CreateProjectWithHttpInfo(ProjectPostModel projectPostModel = default(ProjectPostModel))
        {
            TestGear.Client.Client.RequestOptions localVarRequestOptions = new TestGear.Client.Client.RequestOptions();
        ...
        {
            TestGear.Client.Client.ApiResponse<ProjectModel> localVarResponse = await CreateProjectWithHttpInfoAsync(projectPostModel, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ProjectModel)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<ProjectModel>> CreateProjectWithHttpInfoAsync(ProjectPostModel projectPostModel = default(ProjectPostModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            TestGear.Client.Client.ApiResponse<CustomAttributeModel> localVarResponse = CreateProjectsAttributeWithHttpInfo(id, customAttributePostModel);
            return localVarResponse.Data;
        }
        ...
        /// <param name="customAttributePostModel"> (optional)</param>
        /// <returns>ApiResponse of CustomAttributeModel</returns>
        public TestGear.Client.Client.ApiResponse<CustomAttributeModel> CreateProjectsAttributeWithHttpInfo(string id, CustomAttributePostModel customAttributePostModel = default(CustomAttributePostModel))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->CreateProjectsAttribute");
        ...
        {
            TestGear.Client.Client.ApiResponse<CustomAttributeModel> localVarResponse = await CreateProjectsAttributeWithHttpInfoAsync(id, customAttributePostModel, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CustomAttributeModel)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<CustomAttributeModel>> CreateProjectsAttributeWithHttpInfoAsync(string id, CustomAttributePostModel customAttributePostModel = default(CustomAttributePostModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->CreateProjectsAttribute");
        ...
        /// <param name="attributeId"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public TestGear.Client.Client.ApiResponse<Object> DeleteCustomAttributeTestPlanProjectRelationsWithHttpInfo(string id, Guid attributeId)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->DeleteCustomAttributeTestPlanProjectRelations");
            ...
            localVarRequestOptions.PathParameters.Add("id", TestGear.Client.Client.ClientUtils.ParameterToString(id)); // path parameter
            localVarRequestOptions.PathParameters.Add("attributeId", TestGear.Client.Client.ClientUtils.ParameterToString(attributeId)); // path parameter
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Object>> DeleteCustomAttributeTestPlanProjectRelationsWithHttpInfoAsync(string id, Guid attributeId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->DeleteCustomAttributeTestPlanProjectRelations");
        ...
        /// <param name="id">Project internal (UUID) or global (integer) identifier</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public TestGear.Client.Client.ApiResponse<Object> DeleteProjectWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->DeleteProject");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Object>> DeleteProjectWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->DeleteProject");
        ...
        /// <param name="id">Project internal (UUID) or global (integer) identifier</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public TestGear.Client.Client.ApiResponse<Object> DeleteProjectAutoTestsWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->DeleteProjectAutoTests");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Object>> DeleteProjectAutoTestsWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->DeleteProjectAutoTests");
        ...
        /// <param name="attributeId">Project attribute internal (UUID)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public TestGear.Client.Client.ApiResponse<Object> DeleteProjectsAttributeWithHttpInfo(string id, Guid attributeId)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->DeleteProjectsAttribute");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Object>> DeleteProjectsAttributeWithHttpInfoAsync(string id, Guid attributeId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->DeleteProjectsAttribute");
        ...
        {
            TestGear.Client.Client.ApiResponse<FileParameter> localVarResponse = ExportWithHttpInfo(id, includeAttachments, projectExportQueryModel);
            return localVarResponse.Data;
        }
        ...
        /// <returns>ApiResponse of FileParameter</returns>
        [Obsolete]
        public TestGear.Client.Client.ApiResponse<FileParameter> ExportWithHttpInfo(string id, bool? includeAttachments = default(bool?), ProjectExportQueryModel projectExportQueryModel = default(ProjectExportQueryModel))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->Export");
            ...
            {
                localVarRequestOptions.QueryParameters.Add(TestGear.Client.Client.ClientUtils.ParameterToMultiMap("", "includeAttachments", includeAttachments));
            }
        ...
        {
            TestGear.Client.Client.ApiResponse<FileParameter> localVarResponse = await ExportWithHttpInfoAsync(id, includeAttachments, projectExportQueryModel, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            TestGear.Client.Client.ApiResponse<Guid> localVarResponse = ExportProjectJsonWithHttpInfo(id, timeZoneOffsetInMinutes, projectExportQueryModel);
            return localVarResponse.Data;
        }
        ...
        /// <param name="projectExportQueryModel"> (optional)</param>
        /// <returns>ApiResponse of Guid</returns>
        public TestGear.Client.Client.ApiResponse<Guid> ExportProjectJsonWithHttpInfo(string id, long? timeZoneOffsetInMinutes = default(long?), ProjectExportQueryModel projectExportQueryModel = default(ProjectExportQueryModel))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ExportProjectJson");
            ...
            {
                localVarRequestOptions.HeaderParameters.Add("time-Zone-Offset-In-Minutes", TestGear.Client.Client.ClientUtils.ParameterToString(timeZoneOffsetInMinutes)); // header parameter
            }
            localVarRequestOptions.Data = projectExportQueryModel;
        ...
        {
            TestGear.Client.Client.ApiResponse<Guid> localVarResponse = await ExportProjectJsonWithHttpInfoAsync(id, timeZoneOffsetInMinutes, projectExportQueryModel, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Guid)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Guid>> ExportProjectJsonWithHttpInfoAsync(string id, long? timeZoneOffsetInMinutes = default(long?), ProjectExportQueryModel projectExportQueryModel = default(ProjectExportQueryModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ExportProjectJson");
        ...
        {
            TestGear.Client.Client.ApiResponse<Guid> localVarResponse = ExportProjectWithTestPlansJsonWithHttpInfo(id, timeZoneOffsetInMinutes, projectExportWithTestPlansPostModel);
            return localVarResponse.Data;
        }
        ...
        /// <param name="projectExportWithTestPlansPostModel"> (optional)</param>
        /// <returns>ApiResponse of Guid</returns>
        public TestGear.Client.Client.ApiResponse<Guid> ExportProjectWithTestPlansJsonWithHttpInfo(string id, long? timeZoneOffsetInMinutes = default(long?), ProjectExportWithTestPlansPostModel projectExportWithTestPlansPostModel = default(ProjectExportWithTestPlansPostModel))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ExportProjectWithTestPlansJson");
        ...
        {
            TestGear.Client.Client.ApiResponse<Guid> localVarResponse = await ExportProjectWithTestPlansJsonWithHttpInfoAsync(id, timeZoneOffsetInMinutes, projectExportWithTestPlansPostModel, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Guid)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Guid>> ExportProjectWithTestPlansJsonWithHttpInfoAsync(string id, long? timeZoneOffsetInMinutes = default(long?), ProjectExportWithTestPlansPostModel projectExportWithTestPlansPostModel = default(ProjectExportWithTestPlansPostModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ExportProjectWithTestPlansJson");
        ...
        {
            TestGear.Client.Client.ApiResponse<Guid> localVarResponse = ExportProjectWithTestPlansZipWithHttpInfo(id, timeZoneOffsetInMinutes, projectExportWithTestPlansPostModel);
            return localVarResponse.Data;
        }
        ...
        /// <param name="projectExportWithTestPlansPostModel"> (optional)</param>
        /// <returns>ApiResponse of Guid</returns>
        public TestGear.Client.Client.ApiResponse<Guid> ExportProjectWithTestPlansZipWithHttpInfo(string id, long? timeZoneOffsetInMinutes = default(long?), ProjectExportWithTestPlansPostModel projectExportWithTestPlansPostModel = default(ProjectExportWithTestPlansPostModel))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ExportProjectWithTestPlansZip");
        ...
        {
            TestGear.Client.Client.ApiResponse<Guid> localVarResponse = await ExportProjectWithTestPlansZipWithHttpInfoAsync(id, timeZoneOffsetInMinutes, projectExportWithTestPlansPostModel, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Guid)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Guid>> ExportProjectWithTestPlansZipWithHttpInfoAsync(string id, long? timeZoneOffsetInMinutes = default(long?), ProjectExportWithTestPlansPostModel projectExportWithTestPlansPostModel = default(ProjectExportWithTestPlansPostModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ExportProjectWithTestPlansZip");
        ...
        {
            TestGear.Client.Client.ApiResponse<Guid> localVarResponse = ExportProjectZipWithHttpInfo(id, timeZoneOffsetInMinutes, projectExportQueryModel);
            return localVarResponse.Data;
        }
        ...
        /// <param name="projectExportQueryModel"> (optional)</param>
        /// <returns>ApiResponse of Guid</returns>
        public TestGear.Client.Client.ApiResponse<Guid> ExportProjectZipWithHttpInfo(string id, long? timeZoneOffsetInMinutes = default(long?), ProjectExportQueryModel projectExportQueryModel = default(ProjectExportQueryModel))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ExportProjectZip");
        ...
        {
            TestGear.Client.Client.ApiResponse<Guid> localVarResponse = await ExportProjectZipWithHttpInfoAsync(id, timeZoneOffsetInMinutes, projectExportQueryModel, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Guid)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Guid>> ExportProjectZipWithHttpInfoAsync(string id, long? timeZoneOffsetInMinutes = default(long?), ProjectExportQueryModel projectExportQueryModel = default(ProjectExportQueryModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ExportProjectZip");
        ...
        {
            TestGear.Client.Client.ApiResponse<FileParameter> localVarResponse = ExportWithTestPlansAndConfigurationsWithHttpInfo(id, includeAttachments, projectExportWithTestPlansPostModel);
            return localVarResponse.Data;
        }
        ...
        /// <returns>ApiResponse of FileParameter</returns>
        [Obsolete]
        public TestGear.Client.Client.ApiResponse<FileParameter> ExportWithTestPlansAndConfigurationsWithHttpInfo(string id, bool? includeAttachments = default(bool?), ProjectExportWithTestPlansPostModel projectExportWithTestPlansPostModel = default(ProjectExportWithTestPlansPostModel))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ExportWithTestPlansAndConfigurations");
        ...
        {
            TestGear.Client.Client.ApiResponse<FileParameter> localVarResponse = await ExportWithTestPlansAndConfigurationsWithHttpInfoAsync(id, includeAttachments, projectExportWithTestPlansPostModel, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<FileParameter>> ExportWithTestPlansAndConfigurationsWithHttpInfoAsync(string id, bool? includeAttachments = default(bool?), ProjectExportWithTestPlansPostModel projectExportWithTestPlansPostModel = default(ProjectExportWithTestPlansPostModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ExportWithTestPlansAndConfigurations");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<ProjectModel>> localVarResponse = GetAllProjectsWithHttpInfo(isDeleted, projectName, skip, take, orderBy, searchField, searchValue);
            return localVarResponse.Data;
        }
        ...
        /// <returns>ApiResponse of List&lt;ProjectModel&gt;</returns>
        [Obsolete]
        public TestGear.Client.Client.ApiResponse<List<ProjectModel>> GetAllProjectsWithHttpInfo(bool? isDeleted = default(bool?), string projectName = default(string), int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string))
        {
            TestGear.Client.Client.RequestOptions localVarRequestOptions = new TestGear.Client.Client.RequestOptions();
            ...
            if (projectName != null)
            {
                localVarRequestOptions.QueryParameters.Add(TestGear.Client.Client.ClientUtils.ParameterToMultiMap("", "projectName", projectName));
            }
            if (skip != null)
            {
                localVarRequestOptions.QueryParameters.Add(TestGear.Client.Client.ClientUtils.ParameterToMultiMap("", "Skip", skip));
        ...
        public async System.Threading.Tasks.Task<List<ProjectModel>> GetAllProjectsAsync(bool? isDeleted = default(bool?), string projectName = default(string), int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            TestGear.Client.Client.ApiResponse<List<ProjectModel>> localVarResponse = await GetAllProjectsWithHttpInfoAsync(isDeleted, projectName, skip, take, orderBy, searchField, searchValue, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            TestGear.Client.Client.ApiResponse<CustomAttributeModel> localVarResponse = GetAttributeByProjectIdWithHttpInfo(id, attributeId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="attributeId">Project attribute internal (UUID) or global (integer) identifier</param>
        /// <returns>ApiResponse of CustomAttributeModel</returns>
        public TestGear.Client.Client.ApiResponse<CustomAttributeModel> GetAttributeByProjectIdWithHttpInfo(string id, Guid attributeId)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->GetAttributeByProjectId");
        ...
        {
            TestGear.Client.Client.ApiResponse<CustomAttributeModel> localVarResponse = await GetAttributeByProjectIdWithHttpInfoAsync(id, attributeId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CustomAttributeModel)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<CustomAttributeModel>> GetAttributeByProjectIdWithHttpInfoAsync(string id, Guid attributeId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->GetAttributeByProjectId");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<CustomAttributeModel>> localVarResponse = GetAttributesByProjectIdWithHttpInfo(id, isDeleted);
            return localVarResponse.Data;
        }
        ...
        /// <param name="isDeleted"> (optional)</param>
        /// <returns>ApiResponse of List&lt;CustomAttributeModel&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<CustomAttributeModel>> GetAttributesByProjectIdWithHttpInfo(string id, DeletionState? isDeleted = default(DeletionState?))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->GetAttributesByProjectId");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<CustomAttributeModel>> localVarResponse = await GetAttributesByProjectIdWithHttpInfoAsync(id, isDeleted, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;CustomAttributeModel&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<CustomAttributeModel>>> GetAttributesByProjectIdWithHttpInfoAsync(string id, DeletionState? isDeleted = default(DeletionState?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->GetAttributesByProjectId");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<AutoTestNamespaceModel>> localVarResponse = GetAutoTestsNamespacesWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">Project internal (UUID) or global (integer) identifier</param>
        /// <returns>ApiResponse of List&lt;AutoTestNamespaceModel&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<AutoTestNamespaceModel>> GetAutoTestsNamespacesWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->GetAutoTestsNamespaces");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<AutoTestNamespaceModel>> localVarResponse = await GetAutoTestsNamespacesWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;AutoTestNamespaceModel&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<AutoTestNamespaceModel>>> GetAutoTestsNamespacesWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->GetAutoTestsNamespaces");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<ConfigurationModel>> localVarResponse = GetConfigurationsByProjectIdWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">Project internal (UUID) or global (integer) identifier</param>
        /// <returns>ApiResponse of List&lt;ConfigurationModel&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<ConfigurationModel>> GetConfigurationsByProjectIdWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->GetConfigurationsByProjectId");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<ConfigurationModel>> localVarResponse = await GetConfigurationsByProjectIdWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ConfigurationModel&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<ConfigurationModel>>> GetConfigurationsByProjectIdWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->GetConfigurationsByProjectId");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<CustomAttributeModel>> localVarResponse = GetCustomAttributeTestPlanProjectRelationsWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">Project internal (UUID) or global (integer) identifier</param>
        /// <returns>ApiResponse of List&lt;CustomAttributeModel&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<CustomAttributeModel>> GetCustomAttributeTestPlanProjectRelationsWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->GetCustomAttributeTestPlanProjectRelations");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<CustomAttributeModel>> localVarResponse = await GetCustomAttributeTestPlanProjectRelationsWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;CustomAttributeModel&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<CustomAttributeModel>>> GetCustomAttributeTestPlanProjectRelationsWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->GetCustomAttributeTestPlanProjectRelations");
        ...
        {
            TestGear.Client.Client.ApiResponse<ProjectModel> localVarResponse = GetProjectByIdWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">Project internal (UUID) or global (integer) identifier</param>
        /// <returns>ApiResponse of ProjectModel</returns>
        public TestGear.Client.Client.ApiResponse<ProjectModel> GetProjectByIdWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->GetProjectById");
        ...
        {
            TestGear.Client.Client.ApiResponse<ProjectModel> localVarResponse = await GetProjectByIdWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ProjectModel)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<ProjectModel>> GetProjectByIdWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->GetProjectById");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<SectionModel>> localVarResponse = GetSectionsByProjectIdWithHttpInfo(id, skip, take, orderBy, searchField, searchValue);
            return localVarResponse.Data;
        }
        ...
        /// <param name="searchValue">Value for searching (optional)</param>
        /// <returns>ApiResponse of List&lt;SectionModel&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<SectionModel>> GetSectionsByProjectIdWithHttpInfo(string id, int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->GetSectionsByProjectId");
        ...
        public async System.Threading.Tasks.Task<List<SectionModel>> GetSectionsByProjectIdAsync(string id, int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            TestGear.Client.Client.ApiResponse<List<SectionModel>> localVarResponse = await GetSectionsByProjectIdWithHttpInfoAsync(id, skip, take, orderBy, searchField, searchValue, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;SectionModel&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<SectionModel>>> GetSectionsByProjectIdWithHttpInfoAsync(string id, int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->GetSectionsByProjectId");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<TestPlanModel>> localVarResponse = GetTestPlansByProjectIdWithHttpInfo(id, isDeleted);
            return localVarResponse.Data;
        }
        ...
        /// <param name="isDeleted">If result must consist of only actual/archived test plans (optional)</param>
        /// <returns>ApiResponse of List&lt;TestPlanModel&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<TestPlanModel>> GetTestPlansByProjectIdWithHttpInfo(string id, bool? isDeleted = default(bool?))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->GetTestPlansByProjectId");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<TestPlanModel>> localVarResponse = await GetTestPlansByProjectIdWithHttpInfoAsync(id, isDeleted, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;TestPlanModel&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<TestPlanModel>>> GetTestPlansByProjectIdWithHttpInfoAsync(string id, bool? isDeleted = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->GetTestPlansByProjectId");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<TestRunV2GetModel>> localVarResponse = GetTestRunsByProjectIdWithHttpInfo(id, notStarted, inProgress, stopped, completed, createdDateFrom, createdDateTo, testPlanId, skip, take, orderBy, searchField, searchValue);
            return localVarResponse.Data;
        }
        ...
        /// <param name="searchValue">Value for searching (optional)</param>
        /// <returns>ApiResponse of List&lt;TestRunV2GetModel&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<TestRunV2GetModel>> GetTestRunsByProjectIdWithHttpInfo(string id, bool? notStarted = default(bool?), bool? inProgress = default(bool?), bool? stopped = default(bool?), bool? completed = default(bool?), DateTime? createdDateFrom = default(DateTime?), DateTime? createdDateTo = default(DateTime?), Guid? testPlanId = default(Guid?), int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->GetTestRunsByProjectId");
        ...
        public async System.Threading.Tasks.Task<List<TestRunV2GetModel>> GetTestRunsByProjectIdAsync(string id, bool? notStarted = default(bool?), bool? inProgress = default(bool?), bool? stopped = default(bool?), bool? completed = default(bool?), DateTime? createdDateFrom = default(DateTime?), DateTime? createdDateTo = default(DateTime?), Guid? testPlanId = default(Guid?), int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            TestGear.Client.Client.ApiResponse<List<TestRunV2GetModel>> localVarResponse = await GetTestRunsByProjectIdWithHttpInfoAsync(id, notStarted, inProgress, stopped, completed, createdDateFrom, createdDateTo, testPlanId, skip, take, orderBy, searchField, searchValue, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;TestRunV2GetModel&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<TestRunV2GetModel>>> GetTestRunsByProjectIdWithHttpInfoAsync(string id, bool? notStarted = default(bool?), bool? inProgress = default(bool?), bool? stopped = default(bool?), bool? completed = default(bool?), DateTime? createdDateFrom = default(DateTime?), DateTime? createdDateTo = default(DateTime?), Guid? testPlanId = default(Guid?), int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->GetTestRunsByProjectId");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<WorkItemShortModel>> localVarResponse = GetWorkItemsByProjectIdWithHttpInfo(id, isDeleted, tagNames, includeIterations, skip, take, orderBy, searchField, searchValue);
            return localVarResponse.Data;
        }
        ...
        /// <param name="searchValue">Value for searching (optional)</param>
        /// <returns>ApiResponse of List&lt;WorkItemShortModel&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<WorkItemShortModel>> GetWorkItemsByProjectIdWithHttpInfo(string id, bool? isDeleted = default(bool?), List<string> tagNames = default(List<string>), bool? includeIterations = default(bool?), int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->GetWorkItemsByProjectId");
            ...
            if (tagNames != null)
            {
                localVarRequestOptions.QueryParameters.Add(TestGear.Client.Client.ClientUtils.ParameterToMultiMap("multi", "tagNames", tagNames));
            }
            if (includeIterations != null)
            {
                localVarRequestOptions.QueryParameters.Add(TestGear.Client.Client.ClientUtils.ParameterToMultiMap("", "includeIterations", includeIterations));
            }
            if (skip != null)
            {
                localVarRequestOptions.QueryParameters.Add(TestGear.Client.Client.ClientUtils.ParameterToMultiMap("", "Skip", skip));
        ...
        public async System.Threading.Tasks.Task<List<WorkItemShortModel>> GetWorkItemsByProjectIdAsync(string id, bool? isDeleted = default(bool?), List<string> tagNames = default(List<string>), bool? includeIterations = default(bool?), int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            TestGear.Client.Client.ApiResponse<List<WorkItemShortModel>> localVarResponse = await GetWorkItemsByProjectIdWithHttpInfoAsync(id, isDeleted, tagNames, includeIterations, skip, take, orderBy, searchField, searchValue, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;WorkItemShortModel&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<WorkItemShortModel>>> GetWorkItemsByProjectIdWithHttpInfoAsync(string id, bool? isDeleted = default(bool?), List<string> tagNames = default(List<string>), bool? includeIterations = default(bool?), int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->GetWorkItemsByProjectId");
        ...
        /// <returns>ApiResponse of Object(void)</returns>
        [Obsolete]
        public TestGear.Client.Client.ApiResponse<Object> ImportWithHttpInfo(bool? includeAttachments = default(bool?), FileParameter file = default(FileParameter))
        {
            TestGear.Client.Client.RequestOptions localVarRequestOptions = new TestGear.Client.Client.RequestOptions();
        ...
        /// <returns>Task of ApiResponse</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Object>> ImportWithHttpInfoAsync(bool? includeAttachments = default(bool?), FileParameter file = default(FileParameter), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <returns>ApiResponse of Object(void)</returns>
        [Obsolete]
        public TestGear.Client.Client.ApiResponse<Object> ImportToExistingProjectWithHttpInfo(string id, bool? includeAttachments = default(bool?), FileParameter file = default(FileParameter))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ImportToExistingProject");
        ...
        /// <returns>Task of ApiResponse</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Object>> ImportToExistingProjectWithHttpInfoAsync(string id, bool? includeAttachments = default(bool?), FileParameter file = default(FileParameter), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->ImportToExistingProject");
        ...
        /// <param name="id">Project internal (UUID) or global (integer) identifier</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public TestGear.Client.Client.ApiResponse<Object> RestoreProjectWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->RestoreProject");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Object>> RestoreProjectWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->RestoreProject");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<CustomAttributeGetModel>> localVarResponse = SearchAttributesInProjectWithHttpInfo(id, skip, take, orderBy, searchField, searchValue, projectAttributesFilterModel);
            return localVarResponse.Data;
        }
        ...
        /// <param name="projectAttributesFilterModel"> (optional)</param>
        /// <returns>ApiResponse of List&lt;CustomAttributeGetModel&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<CustomAttributeGetModel>> SearchAttributesInProjectWithHttpInfo(string id, int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), ProjectAttributesFilterModel projectAttributesFilterModel = default(ProjectAttributesFilterModel))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->SearchAttributesInProject");
        ...
        public async System.Threading.Tasks.Task<List<CustomAttributeGetModel>> SearchAttributesInProjectAsync(string id, int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), ProjectAttributesFilterModel projectAttributesFilterModel = default(ProjectAttributesFilterModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            TestGear.Client.Client.ApiResponse<List<CustomAttributeGetModel>> localVarResponse = await SearchAttributesInProjectWithHttpInfoAsync(id, skip, take, orderBy, searchField, searchValue, projectAttributesFilterModel, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;CustomAttributeGetModel&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<CustomAttributeGetModel>>> SearchAttributesInProjectWithHttpInfoAsync(string id, int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), ProjectAttributesFilterModel projectAttributesFilterModel = default(ProjectAttributesFilterModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->SearchAttributesInProject");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<CustomAttributeGetModel>> localVarResponse = SearchTestPlanAttributesInProjectWithHttpInfo(id, skip, take, orderBy, searchField, searchValue, projectAttributesFilterModel);
            return localVarResponse.Data;
        }
        ...
        /// <param name="projectAttributesFilterModel"> (optional)</param>
        /// <returns>ApiResponse of List&lt;CustomAttributeGetModel&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<CustomAttributeGetModel>> SearchTestPlanAttributesInProjectWithHttpInfo(string id, int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), ProjectAttributesFilterModel projectAttributesFilterModel = default(ProjectAttributesFilterModel))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->SearchTestPlanAttributesInProject");
        ...
        public async System.Threading.Tasks.Task<List<CustomAttributeGetModel>> SearchTestPlanAttributesInProjectAsync(string id, int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), ProjectAttributesFilterModel projectAttributesFilterModel = default(ProjectAttributesFilterModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            TestGear.Client.Client.ApiResponse<List<CustomAttributeGetModel>> localVarResponse = await SearchTestPlanAttributesInProjectWithHttpInfoAsync(id, skip, take, orderBy, searchField, searchValue, projectAttributesFilterModel, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;CustomAttributeGetModel&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<CustomAttributeGetModel>>> SearchTestPlanAttributesInProjectWithHttpInfoAsync(string id, int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), ProjectAttributesFilterModel projectAttributesFilterModel = default(ProjectAttributesFilterModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->SearchTestPlanAttributesInProject");
        ...
        /// <param name="customAttributeTestPlanProjectRelationPutModel"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public TestGear.Client.Client.ApiResponse<Object> UpdateCustomAttributeTestPlanProjectRelationsWithHttpInfo(string id, CustomAttributeTestPlanProjectRelationPutModel customAttributeTestPlanProjectRelationPutModel = default(CustomAttributeTestPlanProjectRelationPutModel))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->UpdateCustomAttributeTestPlanProjectRelations");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Object>> UpdateCustomAttributeTestPlanProjectRelationsWithHttpInfoAsync(string id, CustomAttributeTestPlanProjectRelationPutModel customAttributeTestPlanProjectRelationPutModel = default(CustomAttributeTestPlanProjectRelationPutModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->UpdateCustomAttributeTestPlanProjectRelations");
        ...
        /// <param name="projectPutModel"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public TestGear.Client.Client.ApiResponse<Object> UpdateProjectWithHttpInfo(ProjectPutModel projectPutModel = default(ProjectPutModel))
        {
            TestGear.Client.Client.RequestOptions localVarRequestOptions = new TestGear.Client.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Object>> UpdateProjectWithHttpInfoAsync(ProjectPutModel projectPutModel = default(ProjectPutModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="customAttributePutModel"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public TestGear.Client.Client.ApiResponse<Object> UpdateProjectsAttributeWithHttpInfo(string id, CustomAttributePutModel customAttributePutModel = default(CustomAttributePutModel))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->UpdateProjectsAttribute");
