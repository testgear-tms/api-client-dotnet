...
namespace TestGear.Client.Api
{
    ...
    public partial class ProjectsApi : IDisposable, IProjectsApi
    {
        ...
        {
            TestGear.Client.Client.ApiResponse<List<TestPlanWithAnalyticModel>> localVarResponse = ApiV2ProjectsIdTestPlansSearchPostWithHttpInfo(id, mustUpdateCache, skip, take, orderBy, searchField, searchValue, testPlanSearchQueryModel);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<List<TestPlanWithAnalyticModel>> ApiV2ProjectsIdTestPlansSearchPostAsync(string id, bool? mustUpdateCache = default(bool?), int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), TestPlanSearchQueryModel testPlanSearchQueryModel = default(TestPlanSearchQueryModel), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            TestGear.Client.Client.ApiResponse<List<TestPlanWithAnalyticModel>> localVarResponse = await ApiV2ProjectsIdTestPlansSearchPostWithHttpInfoAsync(id, mustUpdateCache, skip, take, orderBy, searchField, searchValue, testPlanSearchQueryModel, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="isDeleted">If result must consist of only actual/deleted work items (optional, default to false)</param>
        /// <returns>ApiResponse of List&lt;CustomAttributeModel&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<CustomAttributeModel>> GetAttributesByProjectIdWithHttpInfo(string id, bool? isDeleted = default(bool?))
        {
            // verify the required parameter 'id' is set
            if (id == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;CustomAttributeModel&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<CustomAttributeModel>>> GetAttributesByProjectIdWithHttpInfoAsync(string id, bool? isDeleted = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new TestGear.Client.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->GetAttributesByProjectId");
