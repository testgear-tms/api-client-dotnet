...
namespace TestGear.Client.Api
{
    ...
    public partial class AttachmentsApi : IDisposable, IAttachmentsApi
    {
        ...
        /// <returns></returns>
        public AttachmentsApi(TestGear.Client.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public AttachmentsApi(HttpClient client, TestGear.Client.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public AttachmentsApi(TestGear.Client.Client.ISynchronousClient client, TestGear.Client.Client.IAsynchronousClient asyncClient, TestGear.Client.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="id"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public TestGear.Client.Client.ApiResponse<Object> ApiV2AttachmentsIdDeleteWithHttpInfo(Guid id)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Object>> ApiV2AttachmentsIdDeleteWithHttpInfoAsync(Guid id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            TestGear.Client.Client.ApiResponse<FileParameter> localVarResponse = ApiV2AttachmentsIdGetWithHttpInfo(id, width, height, resizeType, backgroundColor, preview);
        ...
        /// <param name="preview">If image must be converted to a preview (lower quality, no animation) (optional)</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public TestGear.Client.Client.ApiResponse<FileParameter> ApiV2AttachmentsIdGetWithHttpInfo(Guid id, int? width = default(int?), int? height = default(int?), ImageResizeType? resizeType = default(ImageResizeType?), string backgroundColor = default(string), bool? preview = default(bool?))
        {
            TestGear.Client.Client.RequestOptions localVarRequestOptions = new TestGear.Client.Client.RequestOptions();
        ...
        {
            TestGear.Client.Client.ApiResponse<FileParameter> localVarResponse = await ApiV2AttachmentsIdGetWithHttpInfoAsync(id, width, height, resizeType, backgroundColor, preview, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<FileParameter>> ApiV2AttachmentsIdGetWithHttpInfoAsync(Guid id, int? width = default(int?), int? height = default(int?), ImageResizeType? resizeType = default(ImageResizeType?), string backgroundColor = default(string), bool? preview = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            TestGear.Client.Client.ApiResponse<long> localVarResponse = ApiV2AttachmentsOccupiedFileStorageSizeGetWithHttpInfo();
            return localVarResponse.Data;
        }
        ...
        /// <exception cref="TestGear.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of long</returns>
        public TestGear.Client.Client.ApiResponse<long> ApiV2AttachmentsOccupiedFileStorageSizeGetWithHttpInfo()
        {
            TestGear.Client.Client.RequestOptions localVarRequestOptions = new TestGear.Client.Client.RequestOptions();
        ...
        {
            TestGear.Client.Client.ApiResponse<long> localVarResponse = await ApiV2AttachmentsOccupiedFileStorageSizeGetWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (long)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<long>> ApiV2AttachmentsOccupiedFileStorageSizeGetWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            TestGear.Client.Client.ApiResponse<AttachmentModel> localVarResponse = ApiV2AttachmentsPostWithHttpInfo(file);
            return localVarResponse.Data;
        }
        ...
        /// <param name="file"> (optional)</param>
        /// <returns>ApiResponse of AttachmentModel</returns>
        public TestGear.Client.Client.ApiResponse<AttachmentModel> ApiV2AttachmentsPostWithHttpInfo(FileParameter file = default(FileParameter))
        {
            TestGear.Client.Client.RequestOptions localVarRequestOptions = new TestGear.Client.Client.RequestOptions();
        ...
        {
            TestGear.Client.Client.ApiResponse<AttachmentModel> localVarResponse = await ApiV2AttachmentsPostWithHttpInfoAsync(file, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AttachmentModel)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<AttachmentModel>> ApiV2AttachmentsPostWithHttpInfoAsync(FileParameter file = default(FileParameter), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
