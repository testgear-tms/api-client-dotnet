...
namespace TestGear.Client.Api
{
    ...
    public partial class TagsApi : IDisposable, ITagsApi
    {
        ...
        /// <returns></returns>
        public TagsApi(TestGear.Client.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public TagsApi(HttpClient client, TestGear.Client.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public TagsApi(TestGear.Client.Client.ISynchronousClient client, TestGear.Client.Client.IAsynchronousClient asyncClient, TestGear.Client.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<TagShortModel>> localVarResponse = ApiV2TagsGetWithHttpInfo();
        ...
        /// <exception cref="TestGear.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of List&lt;TagShortModel&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<TagShortModel>> ApiV2TagsGetWithHttpInfo()
        {
        ...
        {
            TestGear.Client.Client.ApiResponse<List<TagShortModel>> localVarResponse = await ApiV2TagsGetWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;TagShortModel&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<TagShortModel>>> ApiV2TagsGetWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            TestGear.Client.Client.ApiResponse<List<TagShortModel>> localVarResponse = ApiV2TagsTestPlansTagsGetWithHttpInfo(skip, take, orderBy, searchField, searchValue);
            return localVarResponse.Data;
        }
        ...
        /// <param name="searchValue">Value for searching (optional)</param>
        /// <returns>ApiResponse of List&lt;TagShortModel&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<TagShortModel>> ApiV2TagsTestPlansTagsGetWithHttpInfo(int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string))
        {
            TestGear.Client.Client.RequestOptions localVarRequestOptions = new TestGear.Client.Client.RequestOptions();
        ...
        {
            TestGear.Client.Client.ApiResponse<List<TagShortModel>> localVarResponse = await ApiV2TagsTestPlansTagsGetWithHttpInfoAsync(skip, take, orderBy, searchField, searchValue, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;TagShortModel&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<TagShortModel>>> ApiV2TagsTestPlansTagsGetWithHttpInfoAsync(int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
