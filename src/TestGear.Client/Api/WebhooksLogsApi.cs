...
namespace TestGear.Client.Api
{
    ...
    public partial class WebhooksLogsApi : IDisposable, IWebhooksLogsApi
    {
        ...
        /// <returns></returns>
        public WebhooksLogsApi(TestGear.Client.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public WebhooksLogsApi(HttpClient client, TestGear.Client.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public WebhooksLogsApi(TestGear.Client.Client.ISynchronousClient client, TestGear.Client.Client.IAsynchronousClient asyncClient, TestGear.Client.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            TestGear.Client.Client.ApiResponse<List<WebHookLogModel>> localVarResponse = ApiV2WebhooksLogsGetWithHttpInfo(projectId, skip, take, orderBy, searchField, searchValue);
        ...
        /// <param name="searchValue">Value for searching (optional)</param>
        /// <returns>ApiResponse of List&lt;WebHookLogModel&gt;</returns>
        public TestGear.Client.Client.ApiResponse<List<WebHookLogModel>> ApiV2WebhooksLogsGetWithHttpInfo(Guid? projectId = default(Guid?), int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string))
        {
        ...
        {
            TestGear.Client.Client.ApiResponse<List<WebHookLogModel>> localVarResponse = await ApiV2WebhooksLogsGetWithHttpInfoAsync(projectId, skip, take, orderBy, searchField, searchValue, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;WebHookLogModel&gt;)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<List<WebHookLogModel>>> ApiV2WebhooksLogsGetWithHttpInfoAsync(Guid? projectId = default(Guid?), int? skip = default(int?), int? take = default(int?), string orderBy = default(string), string searchField = default(string), string searchValue = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="id">Webhook log unique ID</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public TestGear.Client.Client.ApiResponse<Object> ApiV2WebhooksLogsIdDeleteWithHttpInfo(Guid id)
        {
            TestGear.Client.Client.RequestOptions localVarRequestOptions = new TestGear.Client.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<Object>> ApiV2WebhooksLogsIdDeleteWithHttpInfoAsync(Guid id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            TestGear.Client.Client.ApiResponse<WebHookLogModel> localVarResponse = ApiV2WebhooksLogsIdGetWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">Webhook log unique ID</param>
        /// <returns>ApiResponse of WebHookLogModel</returns>
        public TestGear.Client.Client.ApiResponse<WebHookLogModel> ApiV2WebhooksLogsIdGetWithHttpInfo(Guid id)
        {
            TestGear.Client.Client.RequestOptions localVarRequestOptions = new TestGear.Client.Client.RequestOptions();
        ...
        {
            TestGear.Client.Client.ApiResponse<WebHookLogModel> localVarResponse = await ApiV2WebhooksLogsIdGetWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (WebHookLogModel)</returns>
        public async System.Threading.Tasks.Task<TestGear.Client.Client.ApiResponse<WebHookLogModel>> ApiV2WebhooksLogsIdGetWithHttpInfoAsync(Guid id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
